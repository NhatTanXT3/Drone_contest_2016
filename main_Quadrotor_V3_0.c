...
unsigned char task_color[NUMBER_OF_TASK_]={CAPTURE_RED_,3,CAPTURE_GREEN_,CAPTURE_BLUE_,CAPTURE_RED_,CAPTURE_GREEN_,CAPTURE_BLUE_,CAPTURE_RED_,CAPTURE_GREEN_,CAPTURE_BLUE_,CAPTURE_RED_,CAPTURE_GREEN_,CAPTURE_BLUE_,CAPTURE_RED_,CAPTURE_GREEN_,CAPTURE_BLUE_,CAPTURE_RED_,CAPTURE_GREEN_,CAPTURE_BLUE_,CAPTURE_RED_,CAPTURE_GREEN_,3,CAPTURE_BLUE_};//,CAPTURE_RED_,CAPTURE_BLUE_};
	...
	if(Flag.cameraUpdate_error==0)
	{
		...
		else if(task_number<(TASK_NUMBER_MAIN_END_-2))
		{
			if(flag_task_init[task_number]==0)
			{
				...
				{
					PID_y.set_point=-100;
					SerialPutStrLn(UART_COM_2_CONTROLLER_," modify task_1");
				}
				else if(task_number==10)
				{
					PID_y.set_point=-50;
					SerialPutStrLn(UART_COM_2_CONTROLLER_," modify task_2");
				}
				else
					PID_y.set_point=0;
		...
		else if(task_number==TASK_NUMBER_MAIN_END_)
		{
			if(flag_task_init[TASK_NUMBER_MAIN_END_]==0)
			{
				flag_task_init[TASK_NUMBER_MAIN_END_]=1;
				/*
				 * your code begin from here
				 */
				SerialPutStr_NonTer(UART_COM_2_CONTROLLER_,"landing..");
			...
			{
				if(flag_task_finish[TASK_NUMBER_MAIN_END_])
				{
					task_number++;
					/*
					 * your code begin from here
